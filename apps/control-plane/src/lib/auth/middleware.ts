 ...
 * short-circuits with 401. No D1 or KV lookup (D8): the JWT is self-describing.
 * Doesn't check site ownership itself; that's a per-route concern (a token proves *who*
 * you are, not which sites you own — see routes/sites.ts). */
