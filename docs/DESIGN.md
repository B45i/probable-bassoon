...
flowchart TB
    ...
    D1DB[("D1<br/>experiments, variants, conversions")]
    LLM(["LLM provider"])
...
The client-facing contract is a direct consequence of keeping the assignment algorithm a pure function (D1) — it does not need to expose anything about the underlying storage or runtime.
