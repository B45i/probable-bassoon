/**
 * Loaded on every customer page load. This is the client half of the critical path
 * (docs/DESIGN.md §3.5, §7.4): it must load asynchronously, never throw, enforce a hard
 * 150ms timeout, and take no action on any error so the page renders unchanged (D7).
 *
